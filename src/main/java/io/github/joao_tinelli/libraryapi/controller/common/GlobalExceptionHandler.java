package io.github.joao_tinelli.libraryapi.controller.common;

import io.github.joao_tinelli.libraryapi.controller.dto.ErroCampo;
...
public class GlobalExceptionHandler {
    ...
    public ErroResposta handleErrosNaoTratados(RuntimeException e){
        return new ErroResposta(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Ocorreu um erro inesperado. Entre em contato com a administração dos sistema.", List.of());
    }
}
